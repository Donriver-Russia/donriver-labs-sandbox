...
public class SingleThreadEchoServer {
    ...
    public static void main(String[] args) throws IOException {
        try {
            ...
            info("########## SingleThreadEchoServer started successfully ############");
            while (!terminated) {
                Socket clientSocket = serverSocket.accept();
                handleClientSocket(clientSocket);
            }
            info("########## SingleThreadEchoServer gracefully stopped #############");
        } finally {
            shutdownQuietly();
        }
    ...
    private static void handleClientSocket(Socket clientSocket) {
        try (
            ...
            writer.println("Welcome to SingleThreadEchoServer");
    ...
    private static void processServerStop(PrintWriter writer) {
        ...
        writer.println("Server will stop immediately");
        shutdownQuietly();
        terminated = true;
    }
